...
En el caso de que a la conclusión del periodo de vigilancia postclausura estén en funcionamiento pozos o dispositivos de extracción se determinará el caudal de gas de vertedero extraído por la totalidad de estos dispositivos así como las concentraciones de CH4 y SH2.

Además, se estimarán las tasas de emisión difusas y concentraciones de CH4 y SH2 mediante un número representativo de medidas en superficie no inferior a 5 por Ha y mediante métodos adecuados.
...
a) la concentración horaria promedio de CH4 es inferior a 16000 mg/m3 (1) y,

b) la concentración horaria promedio de SH2 es inferior a 7 mg/m3 (1).
