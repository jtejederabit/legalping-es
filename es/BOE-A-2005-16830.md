...
4.5 Renominaciones.-Una renominación es una revisión de una nominación previamente aceptada. Las renominaciones se enviarán al transportista y al distribuidor afectado simultáneamente. La renominación tendrá el mismo contenido y formato que la nominación y seguirá el mismo procedimiento general en cada caso.
...
7.2.1 Requisitos generales.–El balance diario se elaborará para cada día de gas. Antes de las 12 horas posteriores al día de gas el Gestor Técnico del Sistema publicará el balance diario en el SL-ATR.
