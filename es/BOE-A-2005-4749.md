---
title: "Circular 2/2005, de 25 de febrero, sobre ficheros automatizados con datos de carácter personal gestionados por el Banco de España"
identifier: "BOE-A-2005-4749"
country: "es"
rank: "circular"
publication_date: "2005-03-22"
last_updated: "2005-03-22"
status: "in_force"
source: "https://www.boe.es/eli/es/cir/2005/02/25/2"
...
Orden ECO/2004, de 11 de marzo sobre la Central de Riesgos.
...
Control de los riesgos contraídos por las entidades de crédito, de acuerdo con las normas publicadas por el Banco de España.
...
Personas físicas afectadas: Aquéllas con las que el sistema crediticio contrae riesgos susceptibles de declaración.
...
Domicilio (País, ciudad, nombre de la vía, n.º y código postal).
...
N.º de pasaporte, de identidad u otros códigos válidos en el país de origen (sólo no residentes).

Grupo económico.

Categoría a efectos de recursos propios.

Cesiones de datos de carácter personal: Las cesiones, actuales o previstas, tienen como destinatarios:
...
Servicio o unidad ante el que se pueden ejercer los derechos de acceso, rectificación y cancelación: Departamento de Información Financiera y Central de Riesgos.
...
### Fichero. Tasadores más activos por valor de tasación de las sociedades y servicios de tasación
...
Finalidad del fichero y usos previstos del mismo: Disponer de la información actualizada de los tasadores más activos por valor de tasación de las sociedades y servicios de tasación.

Personas físicas afectadas: Los tasadores más activos por valor de tasación de las sociedades y servicios de tasación, según los requisitos del anejo (estado VII) de la Circular 5/2003.

Procedencia y procedimiento de recogida de los datos de carácter personal:

Los datos proceden de las sociedades y servicios de tasación.

El soporte utilizado para su obtención es: Archivos enviados mediante soporte electrónico por vía telemática.
...
### Fichero. Registro de agentes de entidades supervisadas por el Banco de España (*)
...
### Fichero. Cambios de moneda extranjera (*)
...
### Fichero. Proveedores y clientes de bienes y servicios no financieros (*)
...
### Fichero. Suscriptores del servicio de publicaciones (*)
...
### Fichero. Selección y formación del personal (*)
...
### Fichero. Gestión de la biblioteca del Banco de España (*)
...
### Fichero. Control de acceso y permanencia en edificios del Banco de España (*)
...
Los datos se recogen mediante encuestas y entrevistas, por aportación del propio interesado.

El soporte utilizado para la obtención de los datos es papel y digitalización del DNI, mediante scanner.
...
### Fichero. Emisión de tarjetas de identificación
