...
En relación con el contenido de O2 del biogás inyectado en las redes, la inyección de biogás deberá de cumplir lo siguiente:

a) Inyección de biogás en redes de transporte.

Con carácter general, se aceptará la inyección de biogás en la red de transporte con un contenido de O2 hasta el 0,3 mol % siempre que concurran simultáneamente las siguientes circunstancias en el punto de inyección:
...
Con carácter general se aceptará la inyección de biogás en la red con un contenido de O2 hasta el 1 mol % siempre que concurran simultáneamente las siguientes circunstancias en el punto de inyección:
