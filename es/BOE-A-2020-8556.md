---
title: "Circular 6/2020, de 22 de julio, de la Comisión Nacional de los Mercados y la Competencia, por la que se establece la metodología para el cálculo de los peajes de transporte, redes locales y regasificación de gas natural"
identifier: "BOE-A-2020-8556"
country: "es"
rank: "circular"
publication_date: "2020-07-25"
last_updated: "2020-07-25"
status: "in_force"
source: "https://www.boe.es/eli/es/cir/2020/07/22/6"
...
: Retribución fija asociada al Nivel de presión NPi a recuperar mediante el término fijo del peaje correspondiente.

: Coste del nivel de presión i atribuible a los suministros conectados al nivel de presión i, calculado de acuerdo con lo establecido en el punto 4 del presente anexo.
...
: Retribución fija asociada al Nivel de presión NPi a recuperar mediante el término variable del peaje correspondiente.

: Coste del nivel de presión i atribuible a los suministros conectados al nivel de presión j, con calculado de acuerdo con lo establecido en el punto 4 del presente anexo.
...
: Retribución a recuperar mediante el término fijo de los suministros del grupo tarifario k.

: Retribución fija asociada al Nivel de presión NPi a recuperar mediante el término fijo del peaje correspondiente.

: Capacidad contratada equivalente de los suministros del grupo tarifario k abastecidos desde el Nivel de Presión i, en kWh/día.

: Capacidad contratada equivalente de los suministros del grupo tarifario k, en kWh/día.
...
: Coste unitario de distribución cuyo inductor de coste es el cliente, correspondiente al periodo tarifario n.

: Retribución de la distribución cuyo inductor de coste es el cliente, correspondiente al periodo tarifario n.

: Número de clientes conectados en la red de distribución en el periodo tarifario n.
...
: Retribución a recuperar mediante el término variable de los suministros del grupo tarifario k.

: Coste variable unitario para el año j establecida en la correspondiente Resolución de la Comisión Nacional de los Mercados y la Competencia.

: Retribución fija asociada al Nivel de presión NPi a recuperar mediante el término variable del peaje correspondiente.

: Consumo de los suministros del grupo tarifario k abastecidos desde el Nivel de Presión i, en kWh.

: Consumo de los suministros del grupo tarifario k, en kWh.
...
: Consumo máximo del grupo tarifario k-1, en kWh, de acuerdo con lo establecido en el artículo 21 de la circular.

: Número de clientes del grupo tarifario k-1.
