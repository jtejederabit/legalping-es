---
title: "Real Decreto 1048/2013, de 27 de diciembre, por el que se establece la metodología para el cálculo de la retribución de la actividad de distribución de energía eléctrica"
identifier: "BOE-A-2013-13767"
country: "es"
rank: "real_decreto"
publication_date: "2013-12-30"
last_updated: "2013-12-30"
status: "in_force"
source: "https://www.boe.es/eli/es/rd/2013/12/27/1048"
department: "Ministerio de Industria, Energía y Turismo"
official_number: "1048/2013"
...
*RF ibase* = *IN ibase* ∙ *TRFBase* ; Donde:
...
φ i2011→base ; factor que recoge la proporción entre el inmovilizado debido a instalaciones han sido puestas en servicio desde el 1 de enero de 2011 hasta el 31 de diciembre del año base respecto del total de instalaciones de la empresa i que se encuentran en servicio el 31 de diciembre del año base.
...
a) Durante los cinco primeros años en que se haya superado la vida útil regulatoria de la instalación *μ jn* = 1,15.
...
a) Para la evaluación del volumen de inversión de las instalaciones no singulares,  se emplearán los valores unitarios de referencia de inversión a que se hace referencia en el Capítulo V.
...
d) *AY in* valor de las ayudas públicas percibidas por la instalación j. En el caso de que estas ayudas públicas provengan de organismos de la Unión Europea, este valor será el 90 por ciento del importe percibido.

e) *FRRI in* Factor de retardo retributivo de la inversión. Este parámetro se calculará de acuerdo a la formulación recogida en el artículo 12 suponiendo un retardo en el devengo y cobro desde su concesión de la autorización de explotación de un año y medio.
...
b) Si fuera en una cantidad superior al 5 por ciento e inferior al 15 por ciento durante dos o más años consecutivos, el volumen de máximo de inversión que se establece como límite máximo de inversión a que se hace referencia en el artículo 16.1 se verá minorado en la misma cantidad el año n.
...
*IAI**n**= P**IPC–I**· (IPC**n–2**– EFI**IPC–I**) +*(1*– P**IPC–I*)*· (IPRI**n–2**– EFI**IPRI–I**),* Donde:

*IAI**n*: Actualizador de los valores unitarios de inversión empleados en el cálculo del valor de inversión.
...
*P**IPC–I* , es el coeficiente en valor por unidad que representa el peso relativo de la mano de obra en las tareas inversión en redes de distribución.
...
*IAOM**n* : Actualizador de los valores unitarios de operación y mantenimiento empleados en el cálculo de la retribución por operación y mantenimiento.
...
*EFI*IPC–OM Es el factor de eficiencia que expresa el aumento de productividad esperado en una empresa del factor de producción trabajo en las labores de operación y mantenimiento de las redes de distribución.
