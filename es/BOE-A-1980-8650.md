...
m) Los servicios de inspección y control que sea necesario realizar para garantizar al máximo la explotación y funcionamiento adecuados, así como la seguridad de las instalaciones nucleares de fabricación de combustible y la fabricación adecuada del mismo.
...
m) Los servicios de inspección y control reseñados en el apartado m) del número 3 de este artículo quedarán gravados con la cuota única mensual resultante de aplicar el tipo del 0,8 por 100 al valor de la facturación por ventas de elementos combustibles fabricados en la instalación.
