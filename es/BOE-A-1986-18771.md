...
b) En caso de material standard y con análoga excepción a la anteriormente indicada, los suelos deberán:
...
IV. d)*Comunicacion*es de los productores al Instituto y Servicios Oficiales de Control.
...
2.2 La solicitud de etiquetas oficiales para las plantas de vivero de base y certificadas antes del 1 de octubre de cada año.
...
a) Estacas: Longitud mínima: 0,30 m, a partir de la base del nudo inferior, teniendo en cuenta el meritallo superior.
...
b) Para barbados y plantas-injerto basta con las indicaciones incluidas en los números 1, 2, 3, 5 y 6.
