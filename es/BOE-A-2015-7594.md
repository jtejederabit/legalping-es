...
*CF*s: estimación del coste en frontera del gas natural en el semestre natural ‘s’, expresado en c€/KWhPCS y calculado de acuerdo a la siguiente ecuación:
...
*PA*s,j: estimación del coste de los peajes de acceso para el año del semestre ‘s’ y que esté en vigor en dicho semestre, aplicables a un consumidor acogido al escalón ‘j’ del Grupo 2 expresado en c€/KWhPCS y calculado de acuerdo a la siguiente ecuación:

donde *β*s se corresponde con lo descrito anteriormente y el resto de parámetros:
